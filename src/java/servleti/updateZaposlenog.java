 ...
 * @author nikol
 */
public class updateZaposlenog extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int ide = Integer.parseInt(request.getParameter("id"));
         String ime=request.getParameter("tfImeZ" );
       String prezime=request.getParameter("tfPZ" );
        int jmbg=Integer.parseInt(request.getParameter("tfJBMGZ" ));
